...
# Target: invokespecial < Application, Landroid/content/BroadcastReceiver, <init>()V >@2
...
IAAv24 = Int('IAAv24')    # Pointer<717138037>
...
IAAv25 = Int('IAAv25')    # Pointer<1678756705>
